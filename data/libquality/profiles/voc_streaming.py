from libquality.profile import Profile, EncodingFormats
...
def plot_speeds(df):
    ...
    df.loc[:, "encoder"] = df["tag"] + "-" + df["codec"]
...
profile = Profile("voc-streaming", formats, [plot_score_per_rate, plot_score_per_ref, plot_speeds])
